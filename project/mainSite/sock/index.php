...
$cat_op = mysqli_query($conn,$cat_Sql);
if(!$cat_op) 
   echo 'cat =>'.mysqli_error($conn);
?>
<!DOCTYPE html>
<html lang="en">
   <head>
   ...
   <body class="main-layout">
      ...
      <div id="plant" class="section  product">
         ...
         <div class="clothes_main section" style="background-color: #081b30;">
          <div class="container">
            ...
            <div class="row">
               ...
               <?php while($cat = mysqli_fetch_assoc($cat_op)) { ?>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 py-5">
                  <div class="sport_product  py-5" style="background-color: #136af8; border-radius:10px">
                     ...
                     <button class="btn btn-dark"  style="border-radius: 10px;">Discover</button>
                  </div>
               </div>
               <?php } ?>
             </div>
