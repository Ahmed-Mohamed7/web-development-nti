...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (Validate($url, 'empty'))
        ...
        $errors['url'] = errorFormat('invalid url');
    ...
    if (count($errors) == 0) {
        ...
        ##set image
        $disPath = SetImageName($imgName, '../../uploads/');
        ...
        #insert data 
        $sql = "INSERT INTO `vendor`( `name`, `email`, `password`, `phone_number`, `address`, `website_url`, `image`, `country`, `is_verified`) 
                VALUES ('$name','$email','$hashedPassword','$phone','$address','$url','$disPath','$country',0)";
        ...
        if (!$insert_op) {
            ...
            $login_sql = "select * from vendor where id >= LAST_INSERT_ID();";
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form action="<?php echo  htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <?php if (isset($_SESSION['message']['url'])) echo ($_SESSION['message']['url']) ?>
                                        <div class="form-outline mb-3">
                                            <input type="text" id="form2Example17" name="WebsiteUrl" class="form-control" placeholder="Web site url" />
                                        </div>
                                        ...
                                        <?php if (isset($_SESSION['message']['image'])) echo ($_SESSION['message']['image']) ?>
                                        <div class="form-outline mb-3 row">
                                            <div class="col-2">
                                                image
                                            </div>
                                        ...
                                        <div class="pt-1 mb-2">
                                            <button class="btn btn-dark btn-lg btn-block" type="sumbit">SignUp</button>
                                        </div>
